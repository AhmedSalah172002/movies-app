...
const MovieDetails = () => {
    ...
    const getMovieDetails = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/movie/${param.id}?api_key=c4831b5a26afaca3a7b01cf3e52ff1b4&language=ar`)
        setMovie(res.data)
        
    }
    const getMovieShow = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/movie/${param.id}?api_key=c4831b5a26afaca3a7b01cf3e52ff1b4&language=en-Us`)
        setShow(res.data)
